<template>
  <div class="loading_container">
    <div class="loading_img" :style="{backgroundPositionY: -(positionY%7)*2.5 + 'rem'}">
    </div>
    <svg class="load_ellipse" xmlns="http://www.w3.org/2000/svg" version="1.1"></svg>
...
<style lang="scss" scoped>
  ...
  @keyframes ellipse {
    0% {transform: scale(0px);}
    50% {transform: scale(-50px);}
